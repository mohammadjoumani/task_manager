...
class EnglishLightModeTheme implements MainThemeApp {
  @override
  ThemeData themeData = ThemeData(
    ...
    splashColor: ColorManager.colorPrimaryLight1,
    dialogBackgroundColor: ColorManager.colorBackgroundLight,

    textSelectionTheme: const TextSelectionThemeData(
      cursorColor: ColorManager.colorPrimaryLight,
      selectionHandleColor: ColorManager.colorPrimaryLight,
      selectionColor: ColorManager.colorGrey1,
    ),
    ...
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      ...
      circularTrackColor: ColorManager.colorPrimaryLight1,
    ),

    colorScheme: ColorScheme.fromSwatch(
      accentColor: ColorManager.colorPrimaryLight, // but now it should be declared like this
      backgroundColor: ColorManager.colorBackgroundLight,
      primarySwatch: ColorManager.primarySwatch,
      errorColor: ColorManager.colorError,
    ),
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      selectedLabelStyle: StyleManager.getRegularStyle(fontSize: FontSize.s12, color: ColorManager.colorPrimaryLight),
      unselectedLabelStyle: StyleManager.getRegularStyle(fontSize: FontSize.s12, color: ColorManager.colorBlack),
    ),

    bottomSheetTheme: const BottomSheetThemeData(
      backgroundColor: ColorManager.colorBackgroundLight,
      modalBackgroundColor: ColorManager.colorBackgroundLight,
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 0,
      iconTheme: const IconThemeData(color: ColorManager.colorWhite, size: AppSize.s20),
      titleTextStyle: StyleManager.getMediumStyle(fontSize: FontSize.s20, color: ColorManager.colorWhite).copyWith(fontFamily: FontConstants.fontDMSans),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      // hint style
      hintStyle: StyleManager.getRegularStyle(color: ColorManager.colorPlaceHolderLight),
      labelStyle: StyleManager.getMediumStyle(color: ColorManager.colorFontPrimaryLight),
      errorStyle: StyleManager.getRegularStyle(color: ColorManager.colorError),
...
class ArabicLightModeTheme implements MainThemeApp {
  @override
  ThemeData themeData = ThemeData(
    useMaterial3: false,
    primaryColor: ColorManager.colorPrimaryLight,
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 0,
      iconTheme: const IconThemeData(color: ColorManager.colorWhite, size: AppSize.s20),
      titleTextStyle: StyleManager.getMediumStyle(fontSize: FontSize.s20, color: ColorManager.colorWhite).copyWith(fontFamily: FontConstants.fontCairo),
    ),
